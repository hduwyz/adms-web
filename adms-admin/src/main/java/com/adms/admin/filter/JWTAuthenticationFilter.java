package com.adms.admin.filter;

import com.adms.admin.entity.JwtUser;
import com.adms.admin.entity.LoginUser;
import com.adms.admin.util.JwtTokenUtils;
...
import static com.adms.core.util.Constants.SPLIT_COMMA;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response, AuthenticationException failed) throws IOException, ServletException {
        response.setCharacterEncoding("UTF-8");
        response.getWriter().write(JSON.toJSON(new ReturnT<>(ReturnT.FAIL_CODE,"login_param_invalid")).toString());
    }
}